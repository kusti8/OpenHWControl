...
class PollingThread(QtCore.QThread):
    ...
    def calculate_temp_linux(self, temperature_sensors, type):
        """Calculate CPU/GPU temperatures (maximum or average value)"""
        ...
        try:
            ...
            if os.name != 'nt':
                ...
                while self.keep_running:
                    ...
                    temperature_sensors = openhwmon.get_temperature_sensors(None)

                    # Calculate CPU and GPU temperatures
                    current_cpu_temp = self.calculate_temp_linux(temperature_sensors, "cpu")
                    current_gpu_temp = self.calculate_temp_linux(temperature_sensors, "gpu")
