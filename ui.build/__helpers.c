...
MOD_INIT_DECL( hue_plus$hue );
MOD_INIT_DECL( hue_plus$picker );
MOD_INIT_DECL( hue_plus$previous );
MOD_INIT_DECL( hue_plus$webcolors );
MOD_INIT_DECL( openhwcontrol );
MOD_INIT_DECL( openhwcontrol$cooler );
MOD_INIT_DECL( openhwcontrol$gui );
MOD_INIT_DECL( openhwcontrol$ui );
...
MOD_INIT_DECL( usb );
MOD_INIT_DECL( usb$_debug );
MOD_INIT_DECL( usb$_interop );
MOD_INIT_DECL( usb$_lookup );
MOD_INIT_DECL( usb$_objfinalizer );
MOD_INIT_DECL( usb$backend );
MOD_INIT_DECL( usb$backend$libusb0 );
MOD_INIT_DECL( usb$backend$libusb1 );
MOD_INIT_DECL( usb$backend$openusb );
MOD_INIT_DECL( usb$control );
MOD_INIT_DECL( usb$core );
MOD_INIT_DECL( usb$legacy );
MOD_INIT_DECL( usb$libloader );
MOD_INIT_DECL( usb$util );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { (char *)"hue_plus", MOD_INIT_NAME( hue_plus ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"hue_plus.hue", MOD_INIT_NAME( hue_plus$hue ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"hue_plus.picker", MOD_INIT_NAME( hue_plus$picker ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"hue_plus.previous", MOD_INIT_NAME( hue_plus$previous ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"hue_plus.webcolors", MOD_INIT_NAME( hue_plus$webcolors ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"openhwcontrol", MOD_INIT_NAME( openhwcontrol ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"openhwcontrol.cooler", MOD_INIT_NAME( openhwcontrol$cooler ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"openhwcontrol.gui", MOD_INIT_NAME( openhwcontrol$gui ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"openhwcontrol.ui", MOD_INIT_NAME( openhwcontrol$ui ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"pyaudio", MOD_INIT_NAME( pyaudio ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { (char *)"serial.tools", MOD_INIT_NAME( serial$tools ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"serial.tools.list_ports", MOD_INIT_NAME( serial$tools$list_ports ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.tools.list_ports_common", MOD_INIT_NAME( serial$tools$list_ports_common ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.tools.list_ports_linux", MOD_INIT_NAME( serial$tools$list_ports_linux ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.tools.list_ports_osx", MOD_INIT_NAME( serial$tools$list_ports_osx ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.tools.list_ports_posix", MOD_INIT_NAME( serial$tools$list_ports_posix ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.tools.list_ports_windows", MOD_INIT_NAME( serial$tools$list_ports_windows ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serial.win32", MOD_INIT_NAME( serial$win32 ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb", MOD_INIT_NAME( usb ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"usb._debug", MOD_INIT_NAME( usb$_debug ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb._interop", MOD_INIT_NAME( usb$_interop ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb._lookup", MOD_INIT_NAME( usb$_lookup ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb._objfinalizer", MOD_INIT_NAME( usb$_objfinalizer ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.backend", MOD_INIT_NAME( usb$backend ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"usb.backend.libusb0", MOD_INIT_NAME( usb$backend$libusb0 ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.backend.libusb1", MOD_INIT_NAME( usb$backend$libusb1 ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.backend.openusb", MOD_INIT_NAME( usb$backend$openusb ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.control", MOD_INIT_NAME( usb$control ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.core", MOD_INIT_NAME( usb$core ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.legacy", MOD_INIT_NAME( usb$legacy ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.libloader", MOD_INIT_NAME( usb$libloader ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"usb.util", MOD_INIT_NAME( usb$util ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
